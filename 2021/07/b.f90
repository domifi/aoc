...
contains
    ...
    elemental function kl_gauss(n) result(m)
        implicit none
        integer, intent(in) :: n
        integer :: m
        m = (n*n + n) / 2
    end function kl_gauss
end module mod
...
program aoc21_07b
    ...
    ! do stuff
    print *, minval([(sum(kl_gauss(abs(sequence - I))), I = minval(sequence), maxval(sequence))])


end program aoc21_07b
